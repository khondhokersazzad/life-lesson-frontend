    ...
    <div>
      ...
      {!['admin', 'volunteer', 'donor'].includes(role) && (
        <div className="text-center py-10">
          <h2 className="text-xl font-semibold text-gray-600">Role not recognized.</h2>
          <p className="text-gray-500">Please contact support if you believe this is an error.</p>
        </div>
      )}
    </div>
  );
